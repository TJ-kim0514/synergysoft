...
<table id="outer" align="center" width="700" cellspacing="5" cellpadding="0">
	...
	<tr><th>*비밀번호</th><td><input type="password" name="memPw" id="memPw" required></td></tr>
	<tr><th>*비밀번호 확인</th><td><input type="password" id="memPw2" required></td></tr>
	<tr><th>*이 름</th><td><input type="text" name="memName" id="memName" required></td></tr>
	<tr><th>*닉네임</th><td><input type="text" name="memNickNm" id="memNickNm" required></td></tr>
	<tr><th>*생년월일</th><td><input type="date" name="memBirth" required></td></tr>
	<tr><th>*전화번호</th><td><input type="tel" name="memPhone" required></td></tr>
	<tr><th colspan="2">
