...
<body>
	...
	<form action="gupdate.do" method="post" enctype="multipart/form-data">
		...
		<table align="center" width="500" border="1" cellspacing="0"
			...
			<tr>
				<th>제 목</th>
				<td><input type="text" name="guideTitle" size="50"
					value="${ guide.guideTitle }"></td>
			</tr>
			<tr>
				<th>작성자</th>
				<td><input type="text" name="guideUserId" readonly
					value="${ sessionScope.loginUser.userId }"></td>
			</tr>

			<tr>
				<th>내 용</th>
				<td><textarea rows="5" cols="50" name="guideContent">${ guide.guideContent }</textarea></td>
			</tr>
			<tr>
				<th colspan="2"><input type="submit" value="수정하기">
					&nbsp; <input type="reset" value="수정취소"> &nbsp;
					<button
						onclick="javascript:location.href='${pageContext.servletContext.contextPath }/sagBlog.do'; return false;">목록</button>
					&nbsp;
