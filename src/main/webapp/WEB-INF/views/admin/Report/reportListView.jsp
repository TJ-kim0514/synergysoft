...
.notice-table th, .report-table td {
...
<body>
	...
	<div class="container">
		...
		<%-- 항목별 검색기능 --%>
		<%-- 따로 수정 예정 --%>
		<form method="get" action="searchreport.do"
			...
			</select> <input type="search" name="keyword" class="form-control mx-2"
				placeholder="검색어를 입력해주세요" size="50">
			...
			<table class="table table-striped table-bordered report-table">
				<thead class="table-primary">
					<tr class="text-center">
						...
						<th width="500px" style="background-color: #4ba483; color: white;">신고
							사유</th>
						<th width="100px" style="background-color: #4ba483; color: white;">신고자</th>
				...
				<c:forEach items="${ requestScope.list }" var="r">
					<tr>
						...
						<td><a
							href="${ pageContext.servletContext.contextPath }/reportDetail.do?no=${ r.reportId }" class="text-dark text-decoration-none">${ r.reportingReason }</a></td>
						<td class="text-center">익명</td>
						<td class="text-center"><fmt:formatDate value="${ r.reportDate }"
