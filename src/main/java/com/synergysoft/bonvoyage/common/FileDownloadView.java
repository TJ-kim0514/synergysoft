...
@Component("filedown")  // 컨트롤러에서 setViewName으로 설정한 이름으로 id명을 지정해야함
public class FileDownloadView extends AbstractView{

	// 파일 다운로드 처리용 뷰클래스임
	// 스프링에서는 뷰리졸버에 의해서 자동 연결 실행될 뷰클래스를 만들 때,
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		response.setContentType("text/plain; charset=utf-8"); // 파일명은 text이고 파일자체는 plain 타입이다.
		
		// 한글 파일명은 다운되는 클라이언트 컴퓨터와 os(windows) 문자셋과 맞추기함
