...
--가이드 블로그 더미데이터생성
INSERT INTO guide_board (POST_ID, TITLE, CONTENT, LOCATION, CREATED_AT, UPDATED_AT, USER_ID, LIKE_COUNT, FILE1)
VALUES ('P001', '블로그 포스트1입니다.', '블로그에 들어가는 내용입니다. 확인해주세요1', '서울', TO_DATE('2022-11-22', 'YYYY-MM-DD'), TO_DATE('2023-12-01', 'YYYY-MM-DD'), 'user01', 71, NULL);

INSERT INTO guide_board (POST_ID, TITLE, CONTENT, LOCATION, CREATED_AT, UPDATED_AT, USER_ID, LIKE_COUNT, FILE1)
VALUES ('P002', '블로그 포스트2입니다.', '블로그에 들어가는 내용입니다. 확인해주세요2', '대전', TO_DATE('2022-11-23', 'YYYY-MM-DD'), TO_DATE('2023-12-02', 'YYYY-MM-DD'), 'user02', 72, NULL);

INSERT INTO guide_board (POST_ID, TITLE, CONTENT, LOCATION, CREATED_AT, UPDATED_AT, USER_ID, LIKE_COUNT, FILE1)
VALUES ('P003', '블로그 포스트3입니다.', '블로그에 들어가는 내용입니다. 확인해주세요3', '대구', TO_DATE('2022-11-24', 'YYYY-MM-DD'), TO_DATE('2023-12-03', 'YYYY-MM-DD'), 'user01', 73, NULL);

INSERT INTO guide_board (POST_ID, TITLE, CONTENT, LOCATION, CREATED_AT, UPDATED_AT, USER_ID, LIKE_COUNT, FILE1)
VALUES ('P004', '블로그 포스트4입니다.', '블로그에 들어가는 내용입니다. 확인해주세요4', '부산', TO_DATE('2022-11-25', 'YYYY-MM-DD'), TO_DATE('2023-12-04', 'YYYY-MM-DD'), 'user02', 74, NULL);

INSERT INTO guide_board (POST_ID, TITLE, CONTENT, LOCATION, CREATED_AT, UPDATED_AT, USER_ID, LIKE_COUNT, FILE1)
VALUES ('P005', '블로그 포스트5입니다.', '블로그에 들어가는 내용입니다. 확인해주세요5', '서울', TO_DATE('2022-11-26', 'YYYY-MM-DD'), TO_DATE('2023-12-05', 'YYYY-MM-DD'), 'user01', 75, NULL);

INSERT INTO guide_board (POST_ID, TITLE, CONTENT, LOCATION, CREATED_AT, UPDATED_AT, USER_ID, LIKE_COUNT, FILE1)
VALUES ('P006', '블로그 포스트6입니다.', '블로그에 들어가는 내용입니다. 확인해주세요6', '경주', TO_DATE('2022-11-27', 'YYYY-MM-DD'), TO_DATE('2023-12-06', 'YYYY-MM-DD'), 'user02', 76, NULL);

INSERT INTO guide_board (POST_ID, TITLE, CONTENT, LOCATION, CREATED_AT, UPDATED_AT, USER_ID, LIKE_COUNT, FILE1)
VALUES ('P007', '블로그 포스트7입니다.', '블로그에 들어가는 내용입니다. 확인해주세요7', '부산', TO_DATE('2022-11-28', 'YYYY-MM-DD'), TO_DATE('2023-12-07', 'YYYY-MM-DD'), 'user01', 77, NULL);

INSERT INTO guide_board (POST_ID, TITLE, CONTENT, LOCATION, CREATED_AT, UPDATED_AT, USER_ID, LIKE_COUNT, FILE1)
VALUES ('P008', '블로그 포스트8입니다.', '블로그에 들어가는 내용입니다. 확인해주세요8', '대전', TO_DATE('2022-11-29', 'YYYY-MM-DD'), TO_DATE('2023-12-08', 'YYYY-MM-DD'), 'user01', 78, NULL);

INSERT INTO guide_board (POST_ID, TITLE, CONTENT, LOCATION, CREATED_AT, UPDATED_AT, USER_ID, LIKE_COUNT, FILE1)
VALUES ('P009', '블로그 포스트9입니다.', '블로그에 들어가는 내용입니다. 확인해주세요9', '울산', TO_DATE('2022-11-30', 'YYYY-MM-DD'), TO_DATE('2023-12-09', 'YYYY-MM-DD'), 'user01', 79, NULL);

INSERT INTO guide_board (POST_ID, TITLE, CONTENT, LOCATION, CREATED_AT, UPDATED_AT, USER_ID, LIKE_COUNT, FILE1)
VALUES ('P010', '블로그 포스트10입니다.', '블로그에 들어가는 내용입니다. 확인해주세요10', '광주', TO_DATE('2022-12-01', 'YYYY-MM-DD'), TO_DATE('2023-12-10', 'YYYY-MM-DD'), 'user2', 80, NULL);

select * From guide_board;
SELECT * FROM guide_board ORDER BY CREATED_AT DESC;