...
INSERT INTO REPORT (REPORT_ID,POST_ID,REPORT_USER_ID,REPORTING_REASON,DETAIL,REPORT_DATE,CHECKED_ADMIN,CHECKED_ADMIN_ID,CHECKED_ASSIGNED,ASSIGNED_ADMIN_ID) VALUES ('report_10','guide_4','kkk','비속어사용, 혐오발언','비속어 사용.',TIMESTAMP'2024-10-03 00:00:50','Y','ejjung02@beeu.co.kr','N','ejjung02@beeu.co.kr');
INSERT INTO REPORT (REPORT_ID,POST_ID,REPORT_USER_ID,REPORTING_REASON,DETAIL,REPORT_DATE,CHECKED_ADMIN,CHECKED_ADMIN_ID,CHECKED_ASSIGNED,ASSIGNED_ADMIN_ID) VALUES ('report_1','guide_6','0988soso123@gmail.com','test2','test용2',TIMESTAMP'2024-10-03 00:00:05','N','ADMIN NOT CHECKED','N','ADMIN NOT ASSIGNED');
...
INSERT INTO REPORT (REPORT_ID,POST_ID,REPORT_USER_ID,REPORTING_REASON,DETAIL,REPORT_DATE,CHECKED_ADMIN,CHECKED_ADMIN_ID,CHECKED_ASSIGNED,ASSIGNED_ADMIN_ID) VALUES ('report_12','P001','cia','test5','test용5',TIMESTAMP'2024-10-03 00:01:00','N','ADMIN NOT CHECKED','N','ADMIN NOT ASSIGNED');
INSERT INTO REPORT (REPORT_ID,POST_ID,REPORT_USER_ID,REPORTING_REASON,DETAIL,REPORT_DATE,CHECKED_ADMIN,CHECKED_ADMIN_ID,CHECKED_ASSIGNED,ASSIGNED_ADMIN_ID) VALUES ('report_13','P001','ejjung02@beeu.co.kr','test4','test용4',TIMESTAMP'2024-10-03 00:01:00','N','ADMIN NOT CHECKED','N','ADMIN NOT ASSIGNED');
INSERT INTO REPORT (REPORT_ID,POST_ID,REPORT_USER_ID,REPORTING_REASON,DETAIL,REPORT_DATE,CHECKED_ADMIN,CHECKED_ADMIN_ID,CHECKED_ASSIGNED,ASSIGNED_ADMIN_ID) VALUES ('report_14','P001','kkk','test6','test용4',TIMESTAMP'2024-10-03 00:01:00','N','ADMIN NOT CHECKED','N','ADMIN NOT ASSIGNED');
...
INSERT INTO REPORT (REPORT_ID,POST_ID,REPORT_USER_ID,REPORTING_REASON,DETAIL,REPORT_DATE,CHECKED_ADMIN,CHECKED_ADMIN_ID,CHECKED_ASSIGNED,ASSIGNED_ADMIN_ID) VALUES ('report_3','guide_4','ejjung02@beeu.co.kr','비속어','비속어 사용',TIMESTAMP'2024-10-03 00:00:15','N','ADMIN NOT CHECKED','N','ADMIN NOT ASSIGNED');
INSERT INTO REPORT (REPORT_ID,POST_ID,REPORT_USER_ID,REPORTING_REASON,DETAIL,REPORT_DATE,CHECKED_ADMIN,CHECKED_ADMIN_ID,CHECKED_ASSIGNED,ASSIGNED_ADMIN_ID) VALUES ('report_4','guide_3','cia','비속어','비속어 사용 2',TIMESTAMP'2024-10-03 00:00:20','N','ADMIN NOT CHECKED','N','ADMIN NOT ASSIGNED');
INSERT INTO REPORT (REPORT_ID,POST_ID,REPORT_USER_ID,REPORTING_REASON,DETAIL,REPORT_DATE,CHECKED_ADMIN,CHECKED_ADMIN_ID,CHECKED_ASSIGNED,ASSIGNED_ADMIN_ID) VALUES ('report_5','guide_4','ejjung02@beeu.co.kr','c','영어2',TIMESTAMP'2024-10-03 00:00:25','N','ADMIN NOT CHECKED','N','ADMIN NOT ASSIGNED');
INSERT INTO REPORT (REPORT_ID,POST_ID,REPORT_USER_ID,REPORTING_REASON,DETAIL,REPORT_DATE,CHECKED_ADMIN,CHECKED_ADMIN_ID,CHECKED_ASSIGNED,ASSIGNED_ADMIN_ID) VALUES ('report_6','guide_5','0988soso123@gmail.com','d','영어1',TIMESTAMP'2024-10-03 00:00:30','N','ADMIN NOT CHECKED','N','ADMIN NOT ASSIGNED');
...
INSERT INTO REPORT (REPORT_ID,POST_ID,REPORT_USER_ID,REPORTING_REASON,DETAIL,REPORT_DATE,CHECKED_ADMIN,CHECKED_ADMIN_ID,CHECKED_ASSIGNED,ASSIGNED_ADMIN_ID) VALUES ('report_8','guide_5','ejjung02@beeu.co.kr','f','영어4',TIMESTAMP'2024-10-03 00:00:40','Y','ejjung02@beeu.co.kr','N','ejjung02@beeu.co.kr');
commit;